...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Masukkan sisi persegi / Bujur sangkar:',border=0, width=33, font=30).grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="luas Persegi / Bujur sangkar adalah :", border=0, width=33, font=30).grid(row=4, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="keliling Persegi / Bujur sangkar adalah :", border=0, width=33, font=30).grid(row=6, column=0, sticky=W, padx=5, pady=5)
...
if __name__ == '__main__':  
    root = Tk() 
    aplikasi = FrmPersegi(root, "Program luasKeliling persegi/bujur sangkar")
    root.mainloop()