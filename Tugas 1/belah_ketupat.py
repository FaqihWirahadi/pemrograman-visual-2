...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text="masukan sisi:", border=0, width=30, font=30).grid(row=5, column=0, sticky=W, padx=20, pady=5)
        Label(mainFrame, text="Luas bela ketupat adalah:", border=0, width=30, font=30).grid(row=8, column=0, sticky=W, padx=20, pady=5)
        Label(mainFrame, text="keliling bela ketupat adalah:", border=0, width=30, font=30).grid(row=11, column=0, sticky=W, padx=20, pady=5)
