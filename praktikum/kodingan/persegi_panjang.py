...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Panjang:',border=0, width=10, font=30).grid(row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Lebar:", border=0, width=10, font=30).grid(row=1, column=0, sticky=W, padx=5, pady=5)
