...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='masukan alasnya:',border=0, width=35, font=30).grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="masukan sisi yang sejajar dengan alas:", border=0, width=35, font=30).grid(row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="masukan tinggi: ", border=0, width=35, font=30).grid(row=5, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="masukan sisi 1:", border=0, width=35, font=30).grid(row=7, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="masukan sisi 2:", border=0, width=35, font=30).grid(row=9, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="masukan sisi 3:", border=0, width=35, font=30).grid(row=11, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="masukan sisi 4:", border=0, width=35, font=30).grid(row=13, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas  adalah:", border=0, width=35, font=30).grid(row=16, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Keliling  adalah:", border=0, width=35, font=30).grid(row=18, column=0, sticky=W, padx=5, pady=5)
    ...
    def onHitung(self):
        ...
        luas, keliling = self.Luas_Keliling(a, c, t, sa, sb, sc, sd)
    ...
    def Luas_Keliling(self, a, c, t, sa, sb, sc, sd):
        luas = 0.5 * (a + c) * t
        kel = sa + sb + sc + sd
        return luas, kel
